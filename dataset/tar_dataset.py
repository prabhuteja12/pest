...
class TarImageFolder(TarDataset):
    ...
    def __init__(
        self, archive, transform=to_tensor, extensions=(".png", ".jpg", ".jpeg"), is_valid_file=None, root_in_archive=""
    ):
        ...
        if len(self.class_to_idx) == 0:
            ...
            raise IOError(
                f"Only one class (top-level folder) was found: {next(iter(self.class_to_idx))}.\n"
